...
Note that the {KNOWLEDGE_GRAPH} tool can find and analyze the relevant documents, entities, and \
relationships in a single iteration. Do not separate these steps into two iterations, unless you \
