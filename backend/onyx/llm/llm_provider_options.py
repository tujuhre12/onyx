...
PROVIDER_TO_MODELS_MAP = {
    OPENAI_PROVIDER_NAME: set(OPEN_AI_MODEL_NAMES),
    BEDROCK_PROVIDER_NAME: set(BEDROCK_MODEL_NAMES),
    ANTHROPIC_PROVIDER_NAME: set(ANTHROPIC_MODEL_NAMES),
    VERTEXAI_PROVIDER_NAME: set(VERTEXAI_MODEL_NAMES),
}
