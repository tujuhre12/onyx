    ...
    <div className="mt-2 rounded-md border border-error-300 bg-error-50 p-4 text-error-600 max-w-3xl">
      <div className="flex items-center">
        ...
        <div className="ml-2 relative group">
          ...
          <div className="absolute z-10 w-64 p-2 mt-2 text-sm bg-onyx-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-gray-background-200">
