    ...
    <Form className="max-w-4xl">
      ...
      {methodSpecs && methodSpecs.length > 0 && (
        <div className="my-4">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-onyx-white border border-gray-background-200">
              <thead>
                <tr>
      ...
      {showAdvancedOptions && (
        <div>
          ...
          <p className="text-sm mb-6 text-gray-background-600 italic">
                ...
                <div className="space-y-2">
                  {values.customHeaders.map(
                    (header: { key: string; value: string }, index: number) => (
                      <div
                        key={index}
                        className="flex items-center space-x-2 bg-gray-background-50 p-3 rounded-lg shadow-sm"
                      >
                        <Field
                          name={`customHeaders.${index}.key`}
                          placeholder="Header Key"
                          className="flex-1 p-2 border border-gray-background-300 rounded-md focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                        />
                        <Field
