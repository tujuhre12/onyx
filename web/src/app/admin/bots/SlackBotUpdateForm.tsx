...
export const ExistingSlackBotForm = ({
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between h-14">
        ...
        <div className="flex flex-col" ref={dropdownRef}>
          <div className="flex items-center gap-4">
            <div className="border rounded-lg border-gray-background-200">
              <div
                className="flex items-center gap-2 cursor-pointer hover:bg-gray-background-100 p-2"
          ...
          {isExpanded && (
            <div className="bg-onyx-white border rounded-lg border-gray-background-200 shadow-lg absolute mt-12 right-0 z-10 w-full md:w-3/4 lg:w-1/2">
              <div className="p-4">
                <SlackTokensForm
                  isUpdate={true}
      ...
      <div className="mt-2">
        <div className="inline-block border rounded-lg border-gray-background-200 p-2">
          <Checkbox
            label="Enabled"
