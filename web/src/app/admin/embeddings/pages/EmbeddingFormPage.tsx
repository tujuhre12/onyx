    ...
    const ReIndexingButtonComponent = ({
      ...
      return needsReIndex ? (
        <div className="flex mx-auto gap-x-1 ml-auto items-center">
          <button
            className="enabled:cursor-pointer disabled:bg-accent/50 disabled:cursor-not-allowed bg-accent flex gap-x-1 items-center text-onyx-white py-2.5 px-3.5 text-sm font-regular rounded-sm"
        ...
        <button
          className="enabled:cursor-pointer ml-auto disabled:bg-accent/50 disabled:cursor-not-allowed bg-accent flex mx-auto gap-x-1 items-center text-onyx-white py-2.5 px-3.5 text-sm font-regular rounded-sm"
          onClick={async () => {
            updateSearch();
