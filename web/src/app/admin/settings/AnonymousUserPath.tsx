...
export function AnonymousUserPath({
  ...
  return (
    <div className="mt-4 ml-6 max-w-xl p-6 bg-onyx-white shadow-lg border border-gray-background-200 rounded-lg">
      <h4 className="font-semibold text-lg text-gray-background-800 mb-3">
        Anonymous User Access
      </h4>
      <p className="text-gray-background-600 text-sm mb-4">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-2 justify-center items-start">
          <div className="w-full flex-grow  flex items-center rounded-md shadow-sm">
            <span className="inline-flex items-center rounded-l-md border border-r-0 border-gray-background-300 bg-gray-background-50 px-3 text-gray-background-500 sm:text-sm h-10">
              {settings?.webDomain}/anonymous/
            </span>
            <Input
              type="text"
              className="block w-full flex-grow flex-1 rounded-none rounded-r-md border-gray-background-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-10"
