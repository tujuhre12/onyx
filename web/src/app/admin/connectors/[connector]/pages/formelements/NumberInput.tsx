    ...
    <div className="w-full flex flex-col">
      ...
      <Field
        ...
        className={`mt-2 block w-full px-3 py-2 
                bg-onyx-white border border-gray-background-300 rounded-md 
                text-sm shadow-sm placeholder-gray-400
                focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                disabled:bg-gray-background-50 disabled:text-gray-background-500 disabled:border-gray-background-200 disabled:shadow-none
