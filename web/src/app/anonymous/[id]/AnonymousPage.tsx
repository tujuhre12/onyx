...
export default function AnonymousPage({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-background-100">
      <div className="bg-onyx-white p-8 rounded-lg shadow-md">
        ...
        <p className="mt-4 text-gray-background-600 text-center">
