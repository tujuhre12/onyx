...
export function RegenerateDropdown({
  ...
  const Dropdown = (
    <div className="overflow-y-auto py-2 min-w-fit bg-white dark:bg-background-800 rounded-md shadow-lg">
      ...
      {options.map((option) => (
        <div
          key={option.value}
          role="menuitem"
          className={`flex items-center m-1.5 p-1.5 text-sm cursor-pointer focus-visible:outline-0 group relative hover:bg-background-100 dark:hover:bg-background-700 rounded-md my-0 px-3 mx-2 gap-2.5 py-3 !pr-3 ${
