  ...
  return (
    <div className="flex justify-center w-full">
      <div className="relative group">
        ...
        {showExplanation && (
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-background-800 text-onyx-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
