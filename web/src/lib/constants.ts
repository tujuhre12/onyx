...
// Cookie names for agent search feature
export const AGENT_SEARCH_TOGGLED_COOKIE_NAME = "agentSearchIsToggled";
export const LEGACY_PRO_SEARCH_TOGGLED_COOKIE_NAME = "proSearchIsToggled";
