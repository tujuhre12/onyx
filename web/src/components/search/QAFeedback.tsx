...
const QAFeedback = ({
  ...
  return (
    ...
    >
      {feedbackType === "like" ? (
        <ThumbsUpIcon className="my-auto flex flex-shrink-0 text-gray-background-500" />
      ) : (
        <ThumbsDownIcon className="my-auto flex flex-shrink-0 text-gray-background-500" />
      )}
    </div>
  );
};
