...
export default function AuthFlowContainer({
  ...
  return (
    <div className="p-4 flex flex-col items-center justify-center min-h-screen bg-background">
      <div className="w-full max-w-md bg-black pt-8 pb-6 px-8 mx-4 gap-y-4 bg-onyx-white flex items-center flex-col rounded-xl shadow-lg border border-bacgkround-100">
