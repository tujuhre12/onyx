    ...
    embedding_models: [
      {
        ...
        description:
          "Google's latest text embedding model with 3072 dimensions.",
      ...
      },
      {
        ...
        model_name: "gemini-embedding-001",
        description:
          "Google's latest text embedding model with 1536 dimensions.",
        pricePerMillion: 0.15,
        model_dim: 1536,
        normalize: false,
        query_prefix: "",
      ...
      },
      {
        ...
        model_name: "gemini-embedding-001",
        description:
          "Google's latest text embedding model with 768 dimensions.",
        pricePerMillion: 0.15,
        model_dim: 768,
        normalize: false,
        query_prefix: "",
