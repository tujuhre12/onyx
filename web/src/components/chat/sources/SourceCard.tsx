  ...
  return (
    <button
      ...
      className={`w-full ${fullWidth ? "w-full" : "max-w-[200px]"}
        h-[80px] p-3 border border-[1.5px] border-new-background-light  bg-accent-background text-left hover:bg-accent-background-hovered cursor-pointer rounded-lg flex flex-col justify-between overflow-hidden`}
    >
